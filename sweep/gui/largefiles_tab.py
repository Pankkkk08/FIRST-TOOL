...
from sweep.core.largefiles import FileInfo, find_largest_files, find_oldest_files
...
class LargeFilesTab(ttk.Frame):
    ...
    def _build_widgets(self) -> None:
        ...
        ttk.Label(
            bottom,
            text="Quarantined files move to ~/.sweep_trash and can be restored — nothing is "
