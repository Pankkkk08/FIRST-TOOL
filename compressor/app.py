...
Run with:  python run_compressor.py   (from the repo root)
"""
...
from compressor.gui.archive_tab import ArchiveTab
from compressor.gui.photo_tab import PhotoTab
from compressor.gui.video_tab import VideoTab
